from constants import (Color, Display, BULLET_SPEED, SAUCER_SPEED,
                       FD_FRIC, PLAYER_MAX_SPEED, BD_FRIC,
                       PLAYER_SIZE, PLAYER_MAX_RTSPD, SMALL_SAUCER_ACCURACY
                       )
import pygame
import math
import random
...
class Asteroid:
    ...
    def updateAsteroid(self):
        ...
        for v in range(len(self.vertices)):
            ...
            pygame.draw.line(gameDisplay, Color.white, (self.x + this_v[0] * math.cos(this_v[1] * math.pi / 180),
...
def gameLoop(startingState):
    ...
    playOneUpSFX = 0
    intensity = 0
    player = Player(Display.width / 2, Display.height / 2)
    saucer = Saucer()
    ...
    while gameState != "Exit":
        ...
        while gameState == "Menu":
            ...
            drawText("ASTEROIDS", Color.white, Display.width / 2, Display.height / 2, 100)
            drawText("Press any key to START", Color.white, Display.width / 2, Display.height / 2 + 100, 50)
        ...
        if gameState != "Game Over":
            ...
            drawText("Game Over", Color.white, Display.width / 2, Display.height / 2, 100)
            drawText("Press \"R\" to restart!", Color.white, Display.width / 2, Display.height / 2 + 100, 50)
            live = -1
